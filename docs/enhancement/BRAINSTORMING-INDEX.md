...
This document provides a searchable index of all brainstorming topics and their design documents.
...
- [01] Runtime Permission Approval (HITL) → [specification](./topics/01-runtime-permission-approval/00-specification.md)
- [04] Admin Console LLM Configuration → [specification](./topics/04-admin-console-llm-config/00-specification.md)
- [05] Universal Skill Import System → [specification](./topics/05-universal-skill-import/00-specification.md)
...
**Deferred to v1.6+ or post-MVP.**

- [02] WhatsApp Business API Integration → Design not yet created
- [03] HashiCorp Vault Integration → Design not yet created
- [17] Advanced Multi-Agent Orchestrator (Custom) → Design not yet created

---

## By Milestone

### v1.4 (11 topics complete, 0 pending)
...
| # | Topic | Status | Design Doc | Target | Priority |
|---|-------|---------|-------------|---------|----------|
| 01 | Runtime Permission Approval (HITL) | ✅ Complete | [specification](./topics/01-runtime-permission-approval/00-specification.md) | v1.4 | High |
| 02 | WhatsApp Business API Integration | 🟡 Future | Not created | v1.6+ | Medium |
| 03 | HashiCorp Vault Integration | 🟡 Future | Not created | Post-MVP | Low |
| 04 | Admin Console LLM Configuration | ✅ Complete | [specification](./topics/04-admin-console-llm-config/00-specification.md) | v1.4 | High |
| 05 | Universal Skill Import System | ✅ Complete | [specification](./topics/05-universal-skill-import/00-specification.md) | v1.4 | Medium |
...
| 15 | Scheduler Engine & UI | ✅ Complete | [specification](./topics/15-scheduler-engine-ui/00-specification.md) | v1.4 | High |
| 16 | Multi-Agent Tab Architecture | ✅ Complete | [specification](./topics/16-multi-agent-tab-architecture/00-specification.md) | v1.4 | High |
...
Use `git grep` or IDE search in this file to find topics by name:

```bash
# Find all mentions of "Email"
grep -n "Email" INDEX.md

# Find specific topic
grep -n "Topic #19" INDEX.md
```

Or navigate directly to topic folders:
- `docs/enhancement/topics/01-runtime-permission-approval/`
- `docs/enhancement/topics/18-email-system-channel-notifications/`
- etc.
